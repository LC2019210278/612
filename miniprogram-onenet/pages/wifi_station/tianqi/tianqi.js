...
const devicesId = "562733330" // 填写在OneNet上获得的devicesId 形式就是一串数字 例子:9939133
const api_key = "Sx=7vHJJkmka=OpFXfLLfsh7c=k=" // 填写在OneNet上的 api-key 例子: VeFI0HZ44Qn5dZO14AuLbWSlSlI=
1
Page({
  data: {},
  ...
  getDatapoints: function () {
    return new Promise((resolve, reject) => {
      wx.request({
        url: `https://api.heclouds.com/devices/${devicesId}/datapoints?datastream_id=LightIntesity,Humidity,Temperature&limit=20`,
        /**
         * 添加HTTP报文的请求头, 
